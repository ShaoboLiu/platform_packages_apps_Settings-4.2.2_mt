...
public class WirelessSettings extends SettingsPreferenceFragment {
    ...
    private void updateMobileNetworkEnabled() {
        ...
        if (FeatureOption.MTK_GEMINI_SUPPORT) {
            ...
            try {
                sim1Exist = mTelephony.isSimInsert(Phone.GEMINI_SIM_1);
                sim2Exist = mTelephony.isSimInsert(Phone.GEMINI_SIM_2);
            ...
            boolean hasSim = true;
            try {
                hasSim = mTelephony.isSimInsert(Phone.GEMINI_SIM_1);
            } catch (RemoteException e) {
                Xlog.i(TAG, "RemoteException happens......");
            }
