        ...
        sCountDownTimer = new CountDownTimer(mSecondsCountdown * millisSeconds, millisSeconds) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                if (mSecondsCountdown > 1) {
                    mMessage = getString(com.android.settings.R.string.schpwr_shutdown_message, mSecondsCountdown);
                } else {
                    mMessage = getString(com.android.settings.R.string.schpwr_shutdown_message_second, mSecondsCountdown);
                }
