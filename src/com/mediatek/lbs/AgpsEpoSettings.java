...
public class AgpsEpoSettings extends SettingsPreferenceFragment
    ...
    public void onStart() {
        ...
        Cursor settingsCursor = mContentResolver.query(Settings.Secure.CONTENT_URI, null,
    ...
    private void createPreferenceHierarchy() {
        ...
        if ((!FeatureOption.MTK_GPS_SUPPORT && !FeatureOption.MTK_EMULATOR_SUPPORT) || !FeatureOption.MTK_AGPS_APP) {
            if(mAgpsPref != null){
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        Xlog.d(TAG, "[f] onCheckedChanged " + isChecked + "; " + buttonView.isChecked());
            ...
            case CONFIRM_AGPS_DIALOG_ID:
                ...
                .setPositiveButton(R.string.agps_enable_confirm_allow,
                    ...
                    public void onClick(DialogInterface dialoginterface, int i) {
                        ...
                        new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialoginterface, int i) {
                        /// M: see cr [alps00339992] enabe a-gps should be disabeld when you tap cancel
                        Xlog.d(TAG, "-->mAgpsMgr.getStatus()"+ mAgpsMgr.getStatus());
