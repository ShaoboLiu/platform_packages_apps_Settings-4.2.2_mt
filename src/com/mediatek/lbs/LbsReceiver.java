...
public class LbsReceiver extends BroadcastReceiver {
    ...
    private void initSIMStatus(boolean isGemini) {
        ...
        if (isGemini) {
            sim1Status = telephonyManager.getSimStateGemini(Phone.GEMINI_SIM_1);
            sim2Status = telephonyManager.getSimStateGemini(Phone.GEMINI_SIM_2);

            if (TelephonyManager.SIM_STATE_READY == sim1Status && TelephonyManager.SIM_STATE_READY == sim2Status) {
                mCurSIMStatus = DUAL_SIM;
                mCurOperatorCodeOne = telephonyManager.getSimOperatorGemini(Phone.GEMINI_SIM_1);
                mCurOperatorCodeTwo = telephonyManager.getSimOperatorGemini(Phone.GEMINI_SIM_2);
            ...
            sim1Status = telephonyManager.getSimState();
